...
# This needed to change because "proper" SDL2 convention is #include
...
if(APPLE)
	set(SDL2_LIBRARY_TEMP ${SDL2_LIBRARY} "-framework Cocoa")
endif()
...
if(NOT APPLE)
	set(SDL2_LIBRARY_TEMP ${SDL2_LIBRARY} ${CMAKE_THREAD_LIBS_INIT})
endif()

# For MinGW library
if(MINGW)
set(SDL2_LIBRARY_TEMP ${MINGW32_LIBRARY} ${SDL2_LIBRARY})
endif()

# Set the final string here so the GUI reflects the final state.
list(APPEND SDL2_LIBRARY ${SDL2_LIBRARY_TEMP} ${SDL2MAIN_LIBRARY})
