...
void roq::WriteLossless( void ) {
	...
	*/
	out = (byte *)Mem_Alloc(image->pixelsWide()*image->pixelsHigh()*4, TAG_CINEMATIC);
...
int dx,dy,dxMean,dyMean,index2[256],index4[256], dimension;
	...
	cccList = (byte *)Mem_Alloc( numQuadCels * 8, TAG_CINEMATIC);					// maximum length 
	use2 = (bool *)Mem_Alloc(256 *sizeof(bool), TAG_CINEMATIC);
	use4 = (bool *)Mem_Alloc(256 * sizeof(bool), TAG_CINEMATIC);
