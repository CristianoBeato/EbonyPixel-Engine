...
// set normal frame size
		...
		if (token.Icmp( "input") == 0) {
			...
			range = (int *)Mem_ClearedAlloc( num_files * sizeof(int), TAG_CINEMATIC );
			padding = (bool *)Mem_ClearedAlloc( num_files * sizeof(bool), TAG_CINEMATIC);
			padding2 = (bool *)Mem_ClearedAlloc( num_files * sizeof(bool), TAG_CINEMATIC);
			skipnum = (int *)Mem_ClearedAlloc( num_files * sizeof(int), TAG_CINEMATIC);
			skipnum2 = (int *)Mem_ClearedAlloc( num_files * sizeof(int), TAG_CINEMATIC);
			startnum = (int *)Mem_ClearedAlloc( num_files * sizeof(int), TAG_CINEMATIC);
			startnum2 = (int *)Mem_ClearedAlloc( num_files * sizeof(int), TAG_CINEMATIC);
			endnum = (int *)Mem_ClearedAlloc( num_files * sizeof(int), TAG_CINEMATIC);
			endnum2 = (int *)Mem_ClearedAlloc( num_files * sizeof(int), TAG_CINEMATIC);
			numpadding = (int *)Mem_ClearedAlloc( num_files * sizeof(int), TAG_CINEMATIC);
			numpadding2 = (int *)Mem_ClearedAlloc( num_files * sizeof(int), TAG_CINEMATIC);
			numfiles = (int *)Mem_ClearedAlloc( num_files * sizeof(int), TAG_CINEMATIC);
			idStr empty;
