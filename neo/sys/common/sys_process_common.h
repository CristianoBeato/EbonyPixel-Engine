...
public:
	...
	void	SetPhysicalWorkMemory(int minBytes, int maxBytes);
...
{
public:
	void*		DLL_Load(const char* path);
	void*		DLL_GetProcAddress(void* handle, const char* sym);
	void		DLL_Unload(void* handle);
};
