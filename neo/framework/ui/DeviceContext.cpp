...
void idDeviceContext::Init()
{
	...
	cursorImages[CURSOR_ARROW] = declManager->FindMaterial( "common/hud/guicursor_arrow.png" );
	cursorImages[CURSOR_HAND] = declManager->FindMaterial( "common/hud/guicursor_hand.png" );
	cursorImages[CURSOR_HAND_JOY1] = declManager->FindMaterial( "common/hud/guicursor_hand_cross.png" );
	cursorImages[CURSOR_HAND_JOY2] = declManager->FindMaterial( "common/hud/guicursor_hand_circle.tga" );
	cursorImages[CURSOR_HAND_JOY3] = declManager->FindMaterial( "common/hud/guicursor_hand_square.tga" );
	cursorImages[CURSOR_HAND_JOY4] = declManager->FindMaterial( "common/hud/guicursor_hand_triangle.tga" );
	cursorImages[CURSOR_HAND_JOY1] = declManager->FindMaterial( "common/hud/guicursor_hand_a.tga" );
	cursorImages[CURSOR_HAND_JOY2] = declManager->FindMaterial( "common/hud/guicursor_hand_b.tga" );
	cursorImages[CURSOR_HAND_JOY3] = declManager->FindMaterial( "common/hud/guicursor_hand_x.tga" );
	cursorImages[CURSOR_HAND_JOY4] = declManager->FindMaterial( "common/hud/guicursor_hand_y.tga" );
	scrollBarImages[SCROLLBAR_HBACK] = declManager->FindMaterial( "common/hud/assets/scrollbarh.tga" );
	scrollBarImages[SCROLLBAR_VBACK] = declManager->FindMaterial( "common/hud/assets/scrollbarv.tga" );
	scrollBarImages[SCROLLBAR_THUMB] = declManager->FindMaterial( "common/hud/assets/scrollbar_thumb.tga" );
	scrollBarImages[SCROLLBAR_RIGHT] = declManager->FindMaterial( "common/hud/assets/scrollbar_right.png" );
	scrollBarImages[SCROLLBAR_LEFT] = declManager->FindMaterial( "common/hud/assets/scrollbar_left.png" );
	scrollBarImages[SCROLLBAR_UP] = declManager->FindMaterial( "common/hud/assets/scrollbar_up.png" );
	scrollBarImages[SCROLLBAR_DOWN] = declManager->FindMaterial( "common/hud/assets/scrollbar_down.png" );
