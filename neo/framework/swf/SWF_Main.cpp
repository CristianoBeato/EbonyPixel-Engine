...
#include "renderer/Image/DXT/DXTCodec.h"
...
idSWF::idSWF( const char* filename_, idSoundWorld* soundWorld_ )
{
	...
	guiCursor_arrow = declManager->FindMaterial( "textures/common/hud/guicursor_arrow" );
	guiCursor_hand = declManager->FindMaterial( "textures/common/hud/guicursor_hand" );
	
	// RB:
	debugFont = renderSystem->RegisterFont( "Arial Narrow" );
	
	tooltipButtonImage.Append( keyButtonImages_t( "<JOY1>", "textures/common/hud/controller/xb360/a", "textures/common/hud/controller/ps3/cross", 37, 37, 0 ) );
	tooltipButtonImage.Append( keyButtonImages_t( "<JOY2>", "textures/common/hud/controller/xb360/b", "textures/common/hud/controller/ps3/circle", 37, 37, 0 ) );
	tooltipButtonImage.Append( keyButtonImages_t( "<JOY3>", "textures/common/hud/controller/xb360/x", "textures/common/hud/controller/ps3/square", 37, 37, 0 ) );
	tooltipButtonImage.Append( keyButtonImages_t( "<JOY4>", "textures/common/hud/controller/xb360/y", "textures/common/hud/controller/ps3/triangle", 37, 37, 0 ) );
	tooltipButtonImage.Append( keyButtonImages_t( "<JOY_TRIGGER2>", "textures/common/hud/controller/xb360/rt", "textures/common/hud/controller/ps3/r2", 64, 52, 0 ) );
	tooltipButtonImage.Append( keyButtonImages_t( "<JOY_TRIGGER1>", "textures/common/hud/controller/xb360/lt", "textures/common/hud/controller/ps3/l2", 64, 52, 0 ) );
	tooltipButtonImage.Append( keyButtonImages_t( "<JOY5>", "textures/common/hud/controller/xb360/lb", "textures/common/hud/controller/ps3/l1", 52, 32, 0 ) );
	tooltipButtonImage.Append( keyButtonImages_t( "<JOY6>", "textures/common/hud/xb360/rb", "textures/common/hud/controller/ps3/r1", 52, 32, 0 ) );
	tooltipButtonImage.Append( keyButtonImages_t( "<MOUSE1>", "textures/common/hud/controller/mouse1", "", 64, 52, 0 ) );
	tooltipButtonImage.Append( keyButtonImages_t( "<MOUSE2>", "textures/common/hud/controller/mouse2", "", 64, 52, 0 ) );
	tooltipButtonImage.Append( keyButtonImages_t( "<MOUSE3>", "textures/common/hud/controller/mouse3", "", 64, 52, 0 ) );
	...
	if( /*!loadedFromJSON &&*/ ( postLoadExportFlashToJSON.GetBool() || postLoadExportFlashAtlas.GetBool() || postLoadExportFlashToSWF.GetBool() ) )
	{
		...
		if( binaryFileTime != FILE_NOT_FOUND_TIMESTAMP )
		{
			...
			R_WriteImage( atlasFileNameExport, rgba.Ptr(), img.width, img.height, PNG, true, "fs_basepath" );
