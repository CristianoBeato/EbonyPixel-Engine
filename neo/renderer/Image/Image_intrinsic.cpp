...
void idImageManager::CreateIntrinsicImages()
{
	...
	loadingIconImage = ImageFromFile("textures/common/hud/loadingicon2", TF_DEFAULT, TR_CLAMP, TD_DEFAULT, CF_2D);
	hellLoadingIconImage = ImageFromFile("textures/common/hud/loadingicon3", TF_DEFAULT, TR_CLAMP, TD_DEFAULT, CF_2D);
	ErrorImage = ImageFromFile("textures/common/hud/loadingicon3", TF_DEFAULT, TR_CLAMP, TD_DEFAULT, CF_2D);
	SaveIconImage = ImageFromFile("textures/common/hud/loadingicon3", TF_DEFAULT, TR_CLAMP, TD_DEFAULT, CF_2D);
	release_assert(SaveIconImage->referencedOutsideLevelLoad);
	release_assert(ErrorImage->referencedOutsideLevelLoad);
